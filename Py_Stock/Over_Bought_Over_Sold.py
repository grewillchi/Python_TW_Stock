...
def Self_Buy_Sell(df, date):
  ...
  filt_ID = ['1101','2330','2454','3037','5469','2504','4107'
             ,'1609','1618','1513','1514','6806' #重電&電纜&能源
             ,'2634','2630' #軍工
             ,'2408','3006' #記憶體
             ,'2313','2367' #低軌道衛星
             ,'2455','3105','8086' #PA三雄(第三代半導體)
             ,'4906','2345','3596','5388','6285' #網通
             ,'9939'] 
...
if __name__ == "__main__":
  ...
  token = [os.getenv('LINE_GROUP_TEST'),os.getenv('LINE_GROUP_CCFU')]
